...
const Modal = ({ onClose }) => {
    ...
    const handleAnotherAccount = () => {
        try {
            ...
            console.log("some error occured while adding anotehr account",error.messge)
        }
    }
    ...
    return (
        ...
        >
            ...
            >
                <button onClick={logout} className="hover:bg-gray-200 rounded-lg p-2">Logout</button>
                <div onClick={handleAnotherAccount} className="hover:bg-gray-200 rounded-lg p-2">
                    Add another account
                </div>
            </div>
        </div>
        ...
        <div className=" lg:gap-y-3 lg:pr-12 w-[20%] mx-auto">
            ...
            <div className="flex flex-col gap-1">
                ...
                <div className="flex items-center cursor-pointer hover:bg-gray-400 py-2 px-3 rounded-lg text-xl gap-3 sm:gap-3 sm:justify-start sm:flex-row">
                    ...
                    <div className="sm:block hidden">Communities</div>
                </div>
                <div className="flex items-center cursor-pointer hover:bg-gray-400 py-2 px-3 rounded-lg text-xl gap-3 sm:gap-3 sm:justify-start sm:flex-row">
                    <div className="text-3xl sm:text-3xl sm:mr-2">
                        <MdOutlineWorkspacePremium />
                    </div>
                    <div className="sm:block hidden">Premium</div>
                </div>
                <div className="flex items-center cursor-pointer hover:bg-gray-400 py-2 px-3 rounded-lg text-xl gap-3 sm:gap-3 sm:justify-start sm:flex-row">
                    <div className="text-3xl sm:text-3xl sm:mr-2">
                        <MdOutlineVerified />
                    </div>
                    <div className="sm:block hidden">Verified Orgs</div>
                </div>
                ...
                <div className="flex items-center cursor-pointer hover:bg-gray-400 py-2 px-3 rounded-lg text-xl gap-3 sm:gap-3 sm:justify-start sm:flex-row">
                    ...
                    <div className="sm:block hidden">More</div>
                </div>
            </div>
