...
const Bookmarks = () => {
    ...
    return (
        <div className="w-[50%] h-[100vh] bg-white dark:bg-gray-900 border-l border-r">
            ...
            <div className="w-full max-h-[100vh] overflow-auto px-4 pb-4 scrollbar-thin scrollbar-thumb-gray-400">
